...
export default function generateSeriesData(
  data: Questionnaire[],
  ...
  questionnaireDataResult.attractiveness.annoying_enjoyable = calculateAverage(
    questionnaireDataList.attractiveness.annoying_enjoyable
  );
  questionnaireDataResult.attractiveness.bad_good = calculateAverage(
    questionnaireDataList.attractiveness.bad_good
  );
  questionnaireDataResult.attractiveness.unlikable_pleasing = calculateAverage(
    questionnaireDataList.attractiveness.unlikable_pleasing
  );
  questionnaireDataResult.attractiveness.unpleasant_pleasant = calculateAverage(
  ...
  questionnaireDataResult.attractiveness.unfriendly_friendly = calculateAverage(
    questionnaireDataList.attractiveness.unfriendly_friendly
  );

  questionnaireDataResult.novelty.dull_creative = calculateAverage(
    questionnaireDataList.novelty.dull_creative
  );
  questionnaireDataResult.novelty.usual_leadingEdge = calculateAverage(
    questionnaireDataList.novelty.usual_leadingEdge
  );
  questionnaireDataResult.novelty.conventional_inventive = calculateAverage(
    questionnaireDataList.novelty.conventional_inventive
  );
  questionnaireDataResult.novelty.conservative_innovative = calculateAverage(
    questionnaireDataList.novelty.conservative_innovative
  );

  questionnaireDataResult.efficiency.slow_fast = calculateAverage(
    questionnaireDataList.efficiency.slow_fast
  );
  questionnaireDataResult.efficiency.inefficient_efficient = calculateAverage(
    questionnaireDataList.efficiency.inefficient_efficient
  );
  questionnaireDataResult.efficiency.impractical_practical = calculateAverage(
    questionnaireDataList.efficiency.impractical_practical
  );
  questionnaireDataResult.efficiency.cluttered_organized = calculateAverage(
  ...
  questionnaireDataResult.dependability.notSecure_secure = calculateAverage(
  ...
  questionnaireDataResult.perspecuity.complicated_easy = calculateAverage(
    questionnaireDataList.perspecuity.complicated_easy
  );
  questionnaireDataResult.perspecuity.confusing_clear = calculateAverage(
    questionnaireDataList.perspecuity.confusing_clear
  );

  questionnaireDataResult.stimulation.inferior_valuable = calculateAverage(
    questionnaireDataList.stimulation.inferior_valuable
  );
  questionnaireDataResult.stimulation.boring_exciting = calculateAverage(
