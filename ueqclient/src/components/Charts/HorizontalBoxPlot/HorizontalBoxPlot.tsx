...
export default function HorizontalBoxPlot({dataTest, evaluationArea}:{dataTest: Questionnaire[],evaluationArea: EvaluationArea}) {
    ...
    const boxPloxResultChartData = generateBoxPlotChartData("BoxPlot "+evaluationArea, boxPlotData,categoryNames ,evaluationArea+evaluationArea)
  
  return (
      <ReactApexChart options={boxPloxResultChartData.options} series={boxPloxResultChartData.series} type="boxPlot" height={850} width={800} />
  );
};
