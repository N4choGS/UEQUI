...
export default function ChartSurface({
  ...
  const [selectedEvaluationArea, setSelectedEvaluationArea] =
    React.useState<EvaluationArea>("overview");
          ...
          <>
            ...
            <div className="chartWarning">
              {hasError
                ...
                : "Select the filters to view the data"}
            </div>
          </>
        ) : (
          <UXChartContent
            data={data}
            isLoading={isLoading}
            evaluationArea={selectedEvaluationArea}
          />
        )}
      </div>
    </>
