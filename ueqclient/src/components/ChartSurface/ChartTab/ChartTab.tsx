...
export default function ChartTab(
    { setSelectedEvaluationArea }: { setSelectedEvaluationArea : (evalArea : EvaluationArea)=> void }
  ){

    const onSearchButtonClicked = React.useCallback((_event: any, data: any)=>{
      setSelectedEvaluationArea(data?.value || "overview")
      
    },[setSelectedEvaluationArea])

    return (
      <TabList onTabSelect={onSearchButtonClicked} defaultSelectedValue="overview" appearance="subtle">
